...
=== "Stap1"
    ...
    - Als je geen toegang hebt tot een werkend IOS, kun je alleen "proberen" of of het `break sequence` mechanisme werkt. Zo niet, dan moet je de [cold start-methode](index.md#cold-start) gebruiken.
