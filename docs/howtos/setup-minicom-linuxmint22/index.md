...
## Setup
Sluit de blauwe seriële consolekabel aan tussen de COM- of USB-poort van de pc en de Console-poort van de Cisco-switch. Steek vervolgens de stroomkabel in de switch om het apparaat op te starten.

<img src="console-access.png"/>

## Update pakketlijst
Vernieuw de lokale pakketlijst op de Linux Mint LAB-PC om je systeem op de hoogte te brengen van de nieuwste beschikbare pakketten en updates in de gekoppelde software repositories.
...
!!! danger "VDAB cursisten"
    Het programma minicom is al geïnstalleerd op de lab-pc, dus je hoeft de onderstaande installatiestappen niet uit te voeren. Mocht je ze per ongeluk toch uitvoeren, dan kan dat overigens geen kwaad.
...
In dit voorbeeld is een Linux Mint LAB-PC met een seriële kabel verbonden met een Cisco switch. Voer op die PC de volgende opdracht uit om de beschikbare seriële poorten weer te geven. Noteer de naam van de seriële poort die bij je apparaat hoort (in dit geval `/dev/ttyS0`).
...
## Start minicom
Bekijk tab "output" voor verdere instructies.
...
=== "output"
    ...
    Druk op ++enter++ om de switch-prompt te openen. Om Minicom af te sluiten, druk je op de sneltoets ++ctrl++ ++a++ gevolgd door de letter ++x++.
