# Download een Windows 11 multi-versie ISO bestand
...
!!! danger "VDAB cursisten"
    Het "Windows 11 multi-versie ISO-bestand" staat al in de lokale map "Downloads" van de Linux LAB PC en heeft als naam `Windows11_25H2_Pro.iso`. Bekijk gerust onderstaand filmpje, maar je kan het downloaden dus overslaan!
