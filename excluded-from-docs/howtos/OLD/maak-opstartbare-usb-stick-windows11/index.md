# Maak een opstartbare USB-stick voor Windows 11
...
- een [PC met Windows of Linux Mint](../../../../docs/howtos/excluded/tutorials/setup-windows11-linuxmint22-dual-boot-uefi/index.md){:target="_blank"}
- internet verbinding
- een [Windows 11 multi-versie ISO bestand](../download-windows11-multi-versie-iso/index.md){:target="_blank"}
- een applicatie zoals [Rufus (Windows)](../setup-rufus-windows11/index.md){:target="_blank"} of `Ventoy` (Linux Mint)
