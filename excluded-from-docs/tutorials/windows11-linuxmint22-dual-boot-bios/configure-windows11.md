...
## Copy ISO files
In order to [create some installation media with Rufus](../../../docs/tutorials/howtos/install-rufus-windows11/index.md){:target="_blank"} when we're offline later on, copy over the ISO files you need.
<!-- Win, Lin, Clonezilla -->

<img src="../copy-iso-files.png" width="320" height="180"/>

## Applications (optional)
- [Install Rufus on Windows 11](../../../docs/tutorials/howtos/install-rufus-windows11/index.md){:target="_blank"} -> make USB-key to download GRUB and syslinux
- [Install Putty on Windows 11](../../../docs/tutorials/howtos/install-putty-windows11/index.md){:target="_blank"}
- [Install Teraterm on Windows 11](../../../docs/tutorials/howtos/install-teraterm-windows11/index.md){:target="_blank"}
- [Install WinSCP on Windows 11](../../../docs/tutorials/howtos/install-winscp-windows11/index.md){:target="_blank"}
- [Install Wireshark on Windows 11](../../../docs/tutorials/howtos/install-wireshark-windows11/index.md){:target="_blank"} -> download ONLY
- [Install Chrome on Windows 11](../../../docs/tutorials/howtos/install-chrome-windows11/index.md){:target="_blank"}
- [Install Firefox on Windows 11](../../../docs/tutorials/howtos/install-firefox-windows11/index.md){:target="_blank"}
