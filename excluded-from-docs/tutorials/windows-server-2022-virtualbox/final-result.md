...
Now you’re ready to go on to the next step. Checkout some of my [howtos](../../../docs/tutorials/howtos/index.md).

Or you could check out some other [tutorials](../../../docs/tutorials/tutorials/index.md).
